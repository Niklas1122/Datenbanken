...
Zweck: Zentrale Datenbankverbindung und Initialisierung des einfachen Projektschemas.
*/
...
function initializeDatabase(mysqli $connection): void
{
    $queries = [
    ...
    foreach ($queries as $query) {
        if (!$connection->query($query)) {
            die("Datenbankinitialisierung fehlgeschlagen: " . $connection->error);
        }
    }
}
